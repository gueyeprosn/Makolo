...
export function LegalPage() {
  useDocumentTitle('Mentions légales', 'Mentions légales et informations sur le traitement des données de MAKALO.');

  return (
    <div className="container max-w-3xl py-10 lg:py-16">
      <h1 className="makalo-h2">Mentions légales</h1>
      ...
      <div className="prose mt-8 space-y-8 text-doux-600">
        <section aria-labelledby="editeur">
          <h2 id="editeur" className="makalo-h3">
            Éditeur du site
          </h2>
          <p className="mt-2 leading-relaxed">
            MAKALO est une plateforme de mise en relation entre des particuliers ou entreprises souhaitant louer du
        ...
        <section aria-labelledby="role">
          <h2 id="role" className="makalo-h3">
            Rôle de la plateforme
          </h2>
          <p className="mt-2 leading-relaxed">
            MAKALO met en relation clients et prestataires. La plateforme n'est ni propriétaire ni loueur du matériel
        ...
        <section aria-labelledby="donnees">
          <h2 id="donnees" className="makalo-h3">
        ...
        <section aria-labelledby="contenus">
          <h2 id="contenus" className="makalo-h3">
            Contenus publiés et modération
          </h2>
          <p className="mt-2 leading-relaxed">
            Chaque annonce publiée par un prestataire est soumise à validation avant sa mise en ligne. MAKALO peut
        ...
        <section aria-labelledby="propriete">
          <h2 id="propriete" className="makalo-h3">
            Propriété intellectuelle
          </h2>
          <p className="mt-2 leading-relaxed">
            La marque MAKALO, son logo et l'identité visuelle de la plateforme sont protégés. Les photographies des
